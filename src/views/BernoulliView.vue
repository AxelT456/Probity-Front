            ...
            <div class="md:col-span-2">
                <Card class="h-full">
                    ...
                    <CardContent class="pt-6">
                        ...
                        />
                        <div v-if="apiResult && apiResult.result && apiResult.result.data && apiResult.result.data.Sucesion" class="mt-8">
                            ...
                            <div class="bg-gray-100 dark:bg-gray-800 rounded p-4 text-xs max-h-40 overflow-auto">
                                <span v-for="(item, idx) in apiResult.result.data.Sucesion.slice(0, 100)" :key="idx">
